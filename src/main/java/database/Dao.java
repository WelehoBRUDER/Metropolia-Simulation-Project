...
class ServicePoint {
    ...
    public ServicePoint(int simId, double simulationTime, int readyCustomers, int ticketCustomers, int unreadyCustomers, double ticketBoothAverage, int totalTicketCount, double wristbandAverageTime, double ticketAverageTime, double wholeAverageTime, double ticketWristbandTimeRatio) {
        this.simId = simId;
...
public class Dao {
    ...
    public void addServicePoint(double simulationTime, int readyCustomers, int ticketCustomers, int unreadyCustomers, double ticketBoothAverage, int totalTicketCount, double wristbandAverageTime, double ticketAverageTime, double wholeAverageTime, double ticketWristbandTimeRatio){
        Connection conn = DatabaseConnection.getConnection();
        String sql = "INSERT INTO service_point (sim_id, simulation_time, ready_customers, ticket_customers, unready_customers, ticket_booth_average, total_ticket_count, wristband_average_time, ticket_average_time, whole_average_time, ticket_wristband_time_ratio) VALUES (LAST_INSERT_ID(),?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
        ...
        try {
            ...
            ps.setInt(4, unreadyCustomers);
            ps.setDouble(5, ticketBoothAverage);
            ps.setInt(6, totalTicketCount);
            ps.setDouble(7, wristbandAverageTime);
            ps.setDouble(8, ticketAverageTime);
            ps.setDouble(9, wholeAverageTime);
            ps.setDouble(10, ticketWristbandTimeRatio);
            ps.executeUpdate();
        } catch (SQLException e){
            e.printStackTrace();
        }
